...
export class MercuryPlugin implements Plugin {
  config = { id: 'mercury', name: 'Mercury', colorScheme: 'purple' };
...
export const MercuryUI: React.FC<{plugin: MercuryPlugin, currentUserId: string}> = ({ plugin, currentUserId }) => {
  return (
    <PluginBase
      ...
      renderProUI={() => <div>Mercury Advanced Interface</div>}
    />
  );
};
