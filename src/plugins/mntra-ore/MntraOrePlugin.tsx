...
export class MntraOrePlugin implements Plugin {
  config = { id: 'mntra-ore', name: 'MntraOre', colorScheme: 'purple' };
...
export const MntraOreUI: React.FC<{plugin: MntraOrePlugin, currentUserId: string}> = ({ plugin, currentUserId }) => {
  return (
    <PluginBase
      ...
      renderProUI={() => <div>MntraOre Advanced Interface</div>}
    />
  );
};
