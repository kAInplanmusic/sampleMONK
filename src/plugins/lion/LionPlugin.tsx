...
export class LionPlugin implements Plugin {
  config = { id: 'lion', name: 'Lion', colorScheme: 'purple' };
...
export const LionUI: React.FC<{plugin: LionPlugin, currentUserId: string}> = ({ plugin, currentUserId }) => {
  return (
    <PluginBase
      ...
      renderProUI={() => <div>Lion Advanced Interface</div>}
    />
  );
};
