...
export class GeneratePlugin implements Plugin {
  config = { id: 'generate', name: 'Generate', colorScheme: 'purple' };
...
export const GenerateUI: React.FC<{plugin: GeneratePlugin, currentUserId: string}> = ({ plugin, currentUserId }) => {
  return (
    <PluginBase
      ...
      renderProUI={() => <div>Generate Advanced Interface</div>}
    />
  );
};
