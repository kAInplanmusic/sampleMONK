...
export class NoisesPlugin implements Plugin {
  config = { id: 'noises', name: 'Noises', colorScheme: 'purple' };
...
export const NoisesUI: React.FC<{plugin: NoisesPlugin, currentUserId: string}> = ({ plugin, currentUserId }) => {
  return (
    <PluginBase
      ...
      renderProUI={() => <div>Noises Advanced Interface</div>}
    />
  );
};
