...
export class ObscuriumPlugin implements Plugin {
  config = { id: 'obscurium', name: 'Obscurium', colorScheme: 'purple' };
...
export const ObscuriumUI: React.FC<{plugin: ObscuriumPlugin, currentUserId: string}> = ({ plugin, currentUserId }) => {
  return (
    <PluginBase
      ...
      renderProUI={() => <div>Obscurium Advanced Interface</div>}
    />
  );
};
