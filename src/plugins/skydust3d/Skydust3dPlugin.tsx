...
export class Skydust3dPlugin implements Plugin {
  config = { id: 'skydust3d', name: 'Skydust3d', colorScheme: 'purple' };
...
export const Skydust3dUI: React.FC<{plugin: Skydust3dPlugin, currentUserId: string}> = ({ plugin, currentUserId }) => {
  return (
    <PluginBase
      ...
      renderProUI={() => <div>Skydust3d Advanced Interface</div>}
    />
  );
};
