...
export class HauntedSpacesPlugin implements Plugin {
  config = { id: 'haunted-spaces', name: 'HauntedSpaces', colorScheme: 'purple' };
...
export const HauntedSpacesUI: React.FC<{plugin: HauntedSpacesPlugin, currentUserId: string}> = ({ plugin, currentUserId }) => {
  return (
    <PluginBase
      ...
      renderProUI={() => <div>HauntedSpaces Advanced Interface</div>}
    />
  );
};
