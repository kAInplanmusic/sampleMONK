...
export class GlassWorksPlugin implements Plugin {
  config = { id: 'glass-works', name: 'GlassWorks', colorScheme: 'purple' };
...
export const GlassWorksUI: React.FC<{plugin: GlassWorksPlugin, currentUserId: string}> = ({ plugin, currentUserId }) => {
  return (
    <PluginBase
      ...
      renderProUI={() => <div>GlassWorks Advanced Interface</div>}
    />
  );
};
