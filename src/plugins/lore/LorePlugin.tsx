...
export class LorePlugin implements Plugin {
  config = { id: 'lore', name: 'Lore', colorScheme: 'purple' };
...
export const LoreUI: React.FC<{plugin: LorePlugin, currentUserId: string}> = ({ plugin, currentUserId }) => {
  return (
    <PluginBase
      ...
      renderProUI={() => <div>Lore Advanced Interface</div>}
    />
  );
};
