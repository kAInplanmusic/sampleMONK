...
export class SpaceDronePlugin implements Plugin {
  config = { id: 'space-drone', name: 'SpaceDrone', colorScheme: 'purple' };
...
export const SpaceDroneUI: React.FC<{plugin: SpaceDronePlugin, currentUserId: string}> = ({ plugin, currentUserId }) => {
  return (
    <PluginBase
      ...
      renderProUI={() => <div>SpaceDrone Advanced Interface</div>}
    />
  );
};
