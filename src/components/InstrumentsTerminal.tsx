    ...
    <div className="w-full h-full flex flex-col bg-[#161616] rounded-xl border border-neutral-800 text-neutral-300 font-sans shadow-2xl">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 p-8 flex items-center justify-center">
            {isLoading ? <Loader2 className="w-12 h-12 animate-spin text-purple-500" /> : <div className="text-2xl font-black">{activeInstrument ? `${activeInstrument.name} LOADED` : 'No Instrument'}</div>}
        </div>
      </div>
    </div>
  );
