...
export function SpatialPluginTerminal() {
  ...
  return (
    <div className={`w-full h-full flex flex-col bg-[#0a0a0a] rounded-xl border ${lockStatus.active ? 'border-red-500' : 'border-neutral-800'} overflow-hidden text-neutral-300 font-sans shadow-2xl relative ${lockStatus.active && lockStatus.lockedBy !== 'localUser' ? 'opacity-50 grayscale' : ''}`}>
      ...
      <div className="flex items-center justify-between px-6 py-4 bg-linear-to-r from-lime-900/20 to-[#0a0a0a] border-b border-lime-900/30">
      ...
      <div className="flex-1 flex overflow-hidden p-6 gap-6">
        ...
        <div className="flex-1">
            ...
            >
                <div className="w-full h-full max-w-125 max-h-125 bg-black rounded-full border border-neutral-800 overflow-hidden relative shadow-[0_0_50px_rgba(0,0,0,0.5)]">
                    <SpatialCanvas />
                </div>
            </DropTarget>
        </div>
